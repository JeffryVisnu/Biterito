...
<body>
            ...
            <div style="display: flex; align-items: center; gap: 1.5rem;">
                <a href="/" style="text-decoration: none; display: inline-flex; align-items: center;">
                    <div id="navbar-logo-box">
                        <img id="navbar-logo-img" src="{{ asset('logonotagline.png') }}" alt="Biterito"
    ...
    <footer id="site-footer">
        <div id="footer-inner">
            <a href="https://wa.me/6285179978432" target="_blank" rel="noopener noreferrer"
               style="display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.35rem 0.85rem; border-radius: 9999px; font-size: 0.875rem; font-weight: 600; color: white; text-decoration: none; background-color: #25D366; transition: opacity 0.15s;"
